...
final farm = IndustryType(
  ...
  inputsPerSize: {
    water:
        ((GameBalance.outputForDemand(bread.populationDemandPerPersonPerDay) * 1)) *
        0.5,

  },
  outputsPerSize: {
    grain: (GameBalance.outputForDemand(bread.populationDemandPerPersonPerDay) * 1),
  },
  operatingCostPerSizePerDay:
      5,
  workersPerSize:
...
final well = IndustryType(
  ...
  outputsPerSize: {
    water: (GameBalance.outputForDemand(grain.populationDemandPerPersonPerDay) * 0.5) + (GameBalance.outputForDemand(ironOre.populationDemandPerPersonPerDay) * 0.25) + (GameBalance.outputForDemand(bread.populationDemandPerPersonPerDay) * 0.5) + (GameBalance.outputForDemand(turnips.populationDemandPerPersonPerDay) * 0.5),
  },
  operatingCostPerSizePerDay:
      2,
  workersPerSize:
...
final gatheringCamp = IndustryType(
  ...
  outputsPerSize: {
    forage: (GameBalance.outputForDemand(wood.populationDemandPerPersonPerDay) * 0.25) + (GameBalance.outputForDemand(ironOre.populationDemandPerPersonPerDay) * 0.25),
  },
  operatingCostPerSizePerDay:
      3,
  workersPerSize:
...
final loggingCamp = IndustryType(
  ...
  inputsPerSize: {
    forage:
        ((GameBalance.outputForDemand(tools.populationDemandPerPersonPerDay) * 0.5) + (GameBalance.outputForDemand(chair.populationDemandPerPersonPerDay) * 1)) *
        0.25,

  },
  outputsPerSize: {
    wood: (GameBalance.outputForDemand(tools.populationDemandPerPersonPerDay) * 0.5) + (GameBalance.outputForDemand(chair.populationDemandPerPersonPerDay) * 1),
  },
  operatingCostPerSizePerDay:
      4,
  workersPerSize:
...
final mine = IndustryType(
  ...
  inputsPerSize: {
    water:
        ((GameBalance.outputForDemand(tools.populationDemandPerPersonPerDay) * 1)) *
        0.25,
  ...
  outputsPerSize: {
    ironOre: (GameBalance.outputForDemand(tools.populationDemandPerPersonPerDay) * 1),
  },
  operatingCostPerSizePerDay:
      10,
  workersPerSize:
